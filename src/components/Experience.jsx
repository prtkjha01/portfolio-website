...
import sateeqImg from "../assets/sateeq.png";
...
const companies = [
  ...
  },
  {
    id: 3,
    companyName: "Sateeq",
    companyLogo: sateeqImg,
    location: "Noida, Uttar Pradesh",
    companyWebsiteUrl: "https://sateeq.com/",
    Role: "Fullstack Developer Intern",
    Started: "March '23",
    Align: "left",
  },
              ...
              <div className={`timeline-4 ${company.Align}-4`} key={company.id}>
                <div className="card card-grey gradient-custom">
                  <div className="card-body p-4">
                    <p className="large text-white-100 mb-4">
                      {company.Started}
                    </p>
